...
public class Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fullName = findViewById(R.id.manager_name);
...
//                    ID.setText(userId);
                    ...
                    Toast.makeText(com.example.manager.Profile.this,"Logout",Toast.LENGTH_LONG).show();
                }
            }
        });
                ...
                if (task.isSuccessful() && !task.getResult().isEmpty()){
                    ...
                    db.collection("Users").document(documentID).update(userDetail).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            Toast.makeText(com.example.manager.Profile.this, "Successfully Updated", Toast.LENGTH_SHORT).show();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(com.example.manager.Profile.this, "Some Error Occurred",Toast.LENGTH_SHORT).show();
                        }
                    });
                }else {
                    Toast.makeText(com.example.manager.Profile.this, "Failed",Toast.LENGTH_SHORT).show();
                }
