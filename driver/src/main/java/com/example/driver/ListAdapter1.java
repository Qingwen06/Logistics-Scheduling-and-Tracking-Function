...
public class ListAdapter1 extends ArrayAdapter {
    ...
    public ListAdapter1(Activity mContext, List<Students> studentsList){
        super(mContext, R.layout.list_item_delivering,studentsList);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View listItemView = inflater.inflate(R.layout.list_item_delivering, null, true);
