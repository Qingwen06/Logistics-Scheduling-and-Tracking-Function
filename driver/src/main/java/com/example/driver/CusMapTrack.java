...
public class CusMapTrack extends FragmentActivity implements OnMapReadyCallback, TaskLoadedCallback {

    String phone;
    TextView rphone,rname,remail,raddress,deliveryman,deliverymanID,deliverymanPhone,deliverymanEmail;
...
//    FirebaseAuth fAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cus_map_track);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                String id = deliverymanID.getText().toString();
                passid(id);
            }
            @Override
...
//                        Deliverys delivery = dataSnapshot.getValue(Deliverys.class);

//                        double startlatitude = Double.parseDouble(nlatitude);
//                        double startlongitude = Double.parseDouble(nlongitude);
...
//                            new FetchURL(com.example.manager.MapTracking.this).execute(url, "driving");
                            ...
                            String url = getUrl(currentlocation.getPosition(), destination.getPosition(), "driving");
                            new FetchURL(com.example.driver.CusMapTrack.this).execute(url, "driving");
...
//                        Toast.makeText(MapTracking.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            }
            @Override
